...
count = 0
# print(driver.find_element_by_class_name("grid-next").get_attribute("class"))
...
while (count < 300):
    ...
    next = driver.find_element_by_class_name("grid-next")
    if "disabled" in str(next.get_attribute("class")): # no more items
        break	
